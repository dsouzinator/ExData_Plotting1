...
# Plot 1
plot(tab2[, dateTime], tab2[, Global_active_power], type="l", xlab="", ylab="Global Active Power")

# Plot 2
plot(tab2[, dateTime],tab2[, Voltage], type="l", xlab="datetime", ylab="Voltage")
...
# Plot 4
plot(tab2[, dateTime], tab2[,Global_reactive_power], type="l", xlab="datetime", ylab="Global_reactive_power")
